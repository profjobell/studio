...
export const glossaryTermsArray: GlossaryEntry[] = [
  ...
  },
  {
    ...
    htmlDefinition: '<p>Test content. This definition has been simplified to aid in debugging a parsing error. The original detailed content will be restored once the issue is resolved.</p>',
  },
  {
    id: "exposing-false-teachings-kjv-analysis",
    term: "Exposing False Teachings: Biblical Questions and KJV Passages",
    htmlDefinition: `
      <h2>Exposing False Teachings</h2>
      <p>Content for this section is being revised to ensure correct parsing. Please check back.</p>
      <p>This section aims to provide a structured approach to identifying and refuting false teachings using specific biblical questions and passages from the King James Version (KJV) Bible. It will cover a range of historical and modern deviations from orthodox Christian doctrine.</p>
    `,
  },
  {
    id: "f-placeholder",
